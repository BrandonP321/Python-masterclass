...
# strftime() is an sqlite3 function, converts time field into a string
# strftime('format for time in the string', time value, modifier to cause utc time to be converted to local time)
